...
WORK_DIR=/home/juan/work/IR/Gov2/qs-index
...
(
	...
	java -Xmx7512M -server \
		it.unimi.di.big.mg4j.tool.Scan -s 1000000 -S $WORK_DIR/gov2-$split.collection -t EnglishStemmer -I text -c COUNTS $WORK_DIR/gov2-$split >$split.1.out 2>$split.1.err
