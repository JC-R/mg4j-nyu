...
public class DocumentPruningStrategy implements DocumentalPartitioningStrategy, DocumentalClusteringStrategy, Serializable {
    ...
    public DocumentPruningStrategy(String baseline, String strategy, final Long2LongOpenHashMap terms,
    ...
    public static void main(final String[] arg) throws JSAPException, IOException, ConfigurationException, SecurityException,
        ...
        BinIO.storeObject(new DocumentPruningStrategy(jsapResult.getString("titles"), jsapResult.getString("strategy-titles")+"-"+level, terms, postings, documentsGlobal, documentsLocal), jsapResult.getString("strategy") + "-" + String.format("%02d", (int) (t_list[t_list.length - 1] * 100)) + ".strategy");
